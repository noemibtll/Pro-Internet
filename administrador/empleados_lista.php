...
<body><br><br>
        ...
        <tbody class="table table-hover">
            <?php while ($row = $res->fetch_array()) { ?>
                <tr class="table-primary  table-hover " id="<?php echo $row['id'] ?>">
                    ...
                    <td>
                        <a class="btn btn-outline-success" href="./empleados_ver.php?id=<?php echo $row['id'] ?>">
                            Ver detalle
                        </a>
                    </td>
                    <td>
                        <a class="btn btn-outline-info" href="./empleados_editar.php?id=<?php echo $row['id'] ?>">
                            Editar
                        </a>
                    </td>
                    <td>
    ...
    <div class="d-grid gap-2 col-6 mx-auto">
        <a class="btn btn-outline-success" href="./empleados_alta.php">Nuevo registro</a>
    </div>
    <div class="d-grid gap-2 col-6 mx-auto">
